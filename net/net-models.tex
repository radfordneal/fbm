...
and identity --- $\max[a'(u)^2] = 1$, so nothing need actually
be done for this.
...
squared value of tanh.  Units with the softplus activation function 
are treated the same as those with identity activation function.
