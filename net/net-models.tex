...
may alternatively be done separately for each ``channel'' (a subset of
units).
...
in the obvious way when normalization is done separately
for each channel.
...
layers, all units are taken to have typical squared values for their
outputs of one, which is the maximum possible.
